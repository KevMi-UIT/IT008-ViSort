...
public abstract class BaseSort
{
    ...
    public Canvas? drawingCanvas { get; set; } // drawingCanvas trong WPF để vẽ
    public int maxWidth;
    ...
    {
        drawingCanvas.Dispatcher.Invoke(() =>
        {
    ...
    private void DrawRectangle(int index, int height, Color color)
    {
        ...
        drawingCanvas.Dispatcher.Invoke(() => drawingCanvas.Children.Add(rect));
    }
